...
class pi_mppi_base():
    ...
    def __init__(self,v_max, v_min, vdot_max, vdot_min, vddot_max,vddot_min,
        ...
        # Weights
        self.w_1 = 4.5 				#goal reaching cost 0.01
        self.w_2 = .0000001				#mppi 0.0001
        self.w_3 = 1000000			#min altitude 1 
        self.w_4 = 1000000					#desired altitude cost 10
    ...
    #@partial(jit, static_argnums=(0,))
    def compute_cem(self, v_init, v_dot_init, pitch_init, pitch_dot_init, roll_init, roll_dot_init, psi_init, x_init, y_init, z_init, x_fin, y_fin, z_fin, mean,key,x_global,y_global,z_global):
        ...
        x_traj_mppi, y_traj_mppi, z_traj_mppi,psi_mppi,pitch_mppi =	self.compute_rollouts_mppi( x_init, y_init, z_init, psi_init, v_single, roll_single, pitchdot_single,pitch_single)
        ...
        # vdot_mppi = jnp.dot(self.Pdot_jax,c_v_mppi.T)
        # rolldot_mppi = jnp.dot(self.Pdot_jax,c_roll_mppi.T)

        #st = self.state_update(vdot_mppi,v_init,rolldot_mppi,roll_init,pitchdot_new,pitch_init,x_init,y_init,z_init,psi_init)
        ...
        # new_init_controls = st[0:3]
        # new_init_states = st[3:]
